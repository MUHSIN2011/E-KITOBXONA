...
export const SchoolFinancialStatus = ({
  ...
  return (
    <div  className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      <Card data-aos="fade-right" className="bg-blue-50/50 py-2 border-blue-100 dark:bg-gray-800 pt-4 dark:border-0 shadow-none">
      ...
      <Card data-aos="fade-right" className="bg-red-50/50 py-2 border-red-100 dark:bg-gray-800 pt-4 dark:border-0 shadow-none">
        <CardHeader className="pb-2">
      ...
      <Card data-aos="fade-right" className="bg-green-50/50 py-2 border-green-100 dark:bg-gray-800 pt-4 dark:border-0 shadow-none">
        <CardHeader className="pb-2">
      ...
      <Card data-aos="fade-right" className="bg-orange-50/50 py-2 border-orange-100 dark:bg-gray-800 pt-4 dark:border-0 shadow-none">
        <CardHeader className="pb-2">
